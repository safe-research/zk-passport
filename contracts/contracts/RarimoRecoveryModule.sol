...
import "@rarimo/passport-contracts/interfaces/state/IPoseidonSMT.sol";
import "@rarimo/passport-contracts/sdk/AQueryProofExecutor.sol";
import "@rarimo/passport-contracts/sdk/lib/PublicSignalsBuilder.sol";
...
// ============ MAIN CONTRACT ============
contract RarimoSafeRecovery is AQueryProofExecutor {
    ...
    constructor(address registrationSMT_, address verifier_) {
        require(registrationSMT_ != address(0), "Registration SMT address cannot be zero");
